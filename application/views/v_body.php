                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('c_user/edit_user/'.$a['id']);?>" class="btn btn-info">Edit</a>
                                <a href="<?php echo base_url('c_user/delete_user/'.$a['id']);?>" class="btn btn-danger" onclick="return confirm('Anda yakin mau menghapus?');">Delete</a>
                            </td>
                        </tr><?php } }?>
                    </tbody>
                </table>
